...
_C.TASK.MULTI_OBJECT_GOAL_SENSOR.GOAL_SPEC = "CATEGORY_LABEL_TEXT" #"TASK_CATEGORY_ID"
_C.TASK.MULTI_OBJECT_GOAL_SENSOR.GOAL_SPEC_MAX_VAL = 500
# -----------------------------------------------------------------------------
# IMAGEGOAL SENSOR
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# HM3D SEMANTIC SENSOR
# -----------------------------------------------------------------------------
_C.TASK.HMPORT_SEM_SENSOR = CN()
_C.TASK.HMPORT_SEM_SENSOR.TYPE = "HmSemanticSensor"
...
_C.TASK.TOP_DOWN_MAP.DRAW_CURRENT_GOAL_POSITION = True
_C.TASK.TOP_DOWN_MAP.DRAW_CURRENT_GOAL_VIEW_POINTS = True
...
# -----------------------------------------------------------------------------
# # DISTANCE_TO_CURRENT_GOAL Viewpoints MEASUREMENT
# -----------------------------------------------------------------------------
_C.TASK.DISTANCE_TO_CURR_VIEWPOINTS = CN()
_C.TASK.DISTANCE_TO_CURR_VIEWPOINTS.TYPE = "DistanceToCurrGoalViewpoints"
# -----------------------------------------------------------------------------
...
_C.SIMULATOR.SCENE_DATASET = "data/scene_datasets/hm3d/hm3d_annotated_basis.scene_dataset_config.json" #"default"  # the scene dataset to load in the MetaDataMediator. Should contain SIMULATOR.SCENE
